...
app.post('/api/analytics/ping', (req, res) => {
  ...
  if (id && !metricsSkipped(req)) metrics.heartbeat({ id, path: req.body.path, scroll: req.body.scroll, context: metrics.context(req, clientIp(req), cloudflareTrusted(req)) });
