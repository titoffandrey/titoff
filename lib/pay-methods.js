...
// в подвале), остальные — волосяные глифы в общем стиле витрины.
//
...
const METHODS = [
  ...
  { id: 'TO_CARD_TRANSGRAN', name: 'Карта · трансграничный', hint: 'Для карт иностранных банков', kind: 'card', mark: 'globe' },
  { id: 'SBP_TRANSGRAN', name: 'СБП · трансграничный', hint: 'Для карт иностранных банков', kind: 'phone', mark: 'globe' },
  { id: 'TRANSGRAN_SBER', name: 'SberPay · трансграничный', hint: 'Перевод по номеру телефона', kind: 'phone', mark: 'globe' },
  { id: 'TRANSGRAN_ALFA', name: 'Альфа-Банк · трансграничный', hint: 'Карта или номер телефона', kind: 'card', mark: 'globe' },
  { id: 'TRANSGRAN_VTB', name: 'ВТБ · трансграничный', hint: 'Карта или номер телефона', kind: 'card', mark: 'globe' },
  { id: 'TRANSGRAN_TPAY', name: 'TPay · трансграничный', hint: 'Карта или номер телефона', kind: 'card', mark: 'globe' },
  ...
  { id: 'TRANSGRANCARD_TJS', name: 'Карта Таджикистана', hint: 'Трансграничный перевод на карту', kind: 'card', mark: 'globe' }
];
