...
class App {
  ...
  async handle(req, res) {
     ...
     * при этом всё равно обязан быть не `cross-site`.
     *
     ...
     *
     * Убрано целиком, а не сужено: после отказа от `null` оба условия
     * становятся недостижимыми — отсутствующий Origin и так проходит выше.
     */
