...
function note(html) {
  ...
  if (!clients.size || !body || body.length > NOTE_MAX) return false;
...
module.exports = { TOPICS, POLL_MS, NOTE_MAX, watch, bump, note, subscribe, revisions, clientCount: () => clients.size };
