...
const TOPICS = ['orders', 'reviews', 'products', 'settings', 'analytics'];
// Какой файл хранилища какой теме принадлежит. `analytics` здесь нет намеренно:
// её данные лежат в памяти и на диск уходят с большой задержкой.
