    ...
    ['Магазин как продавец', [
      {
        ...
        body: `<div class="field"><label for="set-dadata">Ключ dadata.ru (API-ключ «Подсказок»)</label>
          <input id="set-dadata" name="dadataToken" value="${esc(s.dadataToken || '')}" placeholder="пусто — подсказок не будет" autocomplete="off">
