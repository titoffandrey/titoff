  ...
  const sections = [
    ...
    ? '<p class="form-msg err">Касса включена, но Merchant ID или Secret не заданы либо неверны — ссылка на оплату недоступна.</p>' : ''}
      <div class="a-form-grid">
        ...
        <div class="field"><label for="platega-fee">Комиссия сверху для покупателя, %</label>
          ...
          <p class="field-hint">Укажите процент из тарифа Platega. Магазин покажет комиссию и полную сумму до оплаты. Это поле не меняет тариф у сервиса. Расчёт действует, когда СБП — единственный способ оплаты.</p></div>
      </div>
