...
function chatNewPage(settings, db, found, flash) {
  ...
  return layout(settings, {
    active: 'chat', title: 'Написать покупателю', pendingCount: db.pendingReviewCount(), flash,
    actions: '<a class="btn btn-sm" href="/admin/chat">← Все диалоги</a>',
    body
  });
}
...
module.exports = { loginPage, dashboard, chatList, chatPage, chatNewPage, paymentsPage, productsList, productForm, reviewsList, productReviews, reviewForm, ordersList, analyticsPage, visitorsPage, visitorPage, settingsPage };
