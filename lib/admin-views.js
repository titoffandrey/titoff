...
function analyticsPage(settings, db, snapshot, regionPage) {
  ...
  const body = AV.dashboard(snapshot, { products, regionPage, rangeBase: '/admin/analytics?days=', ordersHref: '/admin/orders', visitorBase: VISITOR_BASE, visitorsHref: VISITORS_BASE });
