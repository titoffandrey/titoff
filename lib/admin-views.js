...
function layout(settings, opts) {
   ...
   * же причине она не гаснет сама (см. `.a-flash` в styles.css) и по ней же
...
<link rel="stylesheet" href="/static/styles.css?v=${R.assetV('styles.css')}">${shellStyle(settings)}${opts.active === 'orders' ? `<link rel="stylesheet" href="/static/admin-orders.css?v=${R.assetV('admin-orders.css')}">` : ''}${opts.active === 'analytics' ? `<link rel="stylesheet" href="/static/admin-metrics.css?v=${R.assetV('admin-metrics.css')}">` : ''}</head>
 ...
 *
 * Уходит она САМА и чистым CSS (`.a-note-flash` в styles.css) — по тому же
