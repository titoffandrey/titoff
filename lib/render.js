    ...
    card = `<div class="co-block pay-invoice">
      ...
      <p class="pay-hint">${hosted
        ? (pay.provider === 'alfabank'
          ...
          : pay.method === 'SBP_ONLINE'
            ? 'Ссылка СБП открывается сама: на телефоне — в приложении банка, на компьютере — страница с QR-кодом и списком банков. Не открылась — нажмите кнопку выше. Сумма там уже указана, подтвердите платёж в банке. Вернувшись сюда, увидите состояние оплаты: страница проверяет его сама.'
