...
const PAY_MARKS = {
  ...
  // Mastercard: круги радиуса 309 с центрами на расстоянии 381.1 — геометрия из
  // официального файла. Одноцветная версия сделана прозрачностью: два круга по
  // 60 % дают на пересечении 84 %, то есть ту же линзу темнее кругов, что и в
  // цветном знаке. Рисовать линзу отдельной фигурой нельзя — в исходнике её
  // роль играет прямоугольник, и полупрозрачные круги показали бы его углы.
  mastercard: '<svg viewBox="0 0 999.2 618" fill="currentColor" aria-hidden="true"><circle cx="309" cy="309" r="309" opacity=".6"/><circle cx="690.1" cy="309" r="309" opacity=".6"/></svg>',
  mastercardWord: '<svg viewBox="49.8 659.3 901.3 116.7" fill="currentColor" aria-hidden="true"><path d="M181.1,774.3v-51.5c0-19.7-12-32.6-32.6-32.6 c-10.3,0-21.5,3.4-29.2,14.6c-6-9.4-14.6-14.6-27.5-14.6c-8.6,0-17.2,2.6-24,12v-10.3h-18v82.4h18v-45.5c0-14.6,7.7-21.5,19.7-21.5 s18,7.7,18,21.5v45.5h18v-45.5c0-14.6,8.6-21.5,19.7-21.5c12,0,18,7.7,18,21.5v45.5H181.1z M448.1,691.9h-29.2V667h-18v24.9h-16.3 v16.3h16.3v37.8c0,18.9,7.7,30,28.3,30c7.7,0,16.3-2.6,22.3-6l-5.2-15.5c-5.2,3.4-11.2,4.3-15.5,4.3c-8.6,0-12-5.2-12-13.7v-36.9 h29.2V691.9z M600.9,690.1c-10.3,0-17.2,5.2-21.5,12v-10.3h-18v82.4h18v-46.4c0-13.7,6-21.5,17.2-21.5c3.4,0,7.7,0.9,11.2,1.7 l5.2-17.2C609.4,690.1,604.3,690.1,600.9,690.1L600.9,690.1z M370,698.7c-8.6-6-20.6-8.6-33.5-8.6c-20.6,0-34.3,10.3-34.3,26.6 c0,13.7,10.3,21.5,28.3,24l8.6,0.9c9.4,1.7,14.6,4.3,14.6,8.6c0,6-6.9,10.3-18.9,10.3c-12,0-21.5-4.3-27.5-8.6l-8.6,13.7 c9.4,6.9,22.3,10.3,35.2,10.3c24,0,37.8-11.2,37.8-26.6c0-14.6-11.2-22.3-28.3-24.9l-8.6-0.9c-7.7-0.9-13.7-2.6-13.7-7.7 c0-6,6-9.4,15.5-9.4c10.3,0,20.6,4.3,25.8,6.9L370,698.7L370,698.7z M848.9,690.1c-10.3,0-17.2,5.2-21.5,12v-10.3h-18v82.4h18v-46.4 c0-13.7,6-21.5,17.2-21.5c3.4,0,7.7,0.9,11.2,1.7L861,691C857.5,690.1,852.4,690.1,848.9,690.1L848.9,690.1z M618.9,733.1 c0,24.9,17.2,42.9,43.8,42.9c12,0,20.6-2.6,29.2-9.4l-8.6-14.6c-6.9,5
  sbpWord: '<svg viewBox="105.27 22.73 101.39 41.91" fill="currentColor" aria-hidden="true"><path d="m 206.66462,34.253692 v 29.338 h -10.476 v -20.58 h -10.087 v 20.58 h -10.476 v -29.34 h 31.039 z" inkscape:connector-curvature="0" /><path d="m 154.11062,64.640692 c 9.378,0 16.342,-5.75 16.342,-14.467 0,-8.437 -5.138,-13.915 -13.725,-13.915 -3.963,0 -7.233,1.395 -9.696,3.802 0.588,-4.975 4.795,-8.607 9.427,-8.607 1.069,0 9.117,-0.017 9.117,-0.017 l 4.551,-8.709 c 0,0 -10.104,0.23 -14.801,0.23 -10.732,0.187 -17.981,9.942 -17.981,21.79 0,13.803 7.07,19.893 16.766,19.893 z m 0.057,-20.668 c 3.482,0 5.896,2.288 5.896,6.2 0,3.521 -2.145,6.422 -5.896,6.43 -3.588,0 -6.002,-2.688 -6.002,-6.37 0,-3.913 2.414,-6.26 6.002,-6.26 z" inkscape:connector-curvature="0" /><path d="m 128.81762,53.769692 c 0,0 -2.474,1.426 -6.169,1.696 -4.248,0.126 -8.033,-2.557 -8.033,-7.324 0,-4.65 3.34,-7.315 7.926,-7.315 2.812,0 6.532,1.949 6.532,1.949 0,0 2.722,-4.995 4.132,-7.493 -2.582,-1.957 -6.021,-3.03 -10.021,-3.03 -10.095,0 -17.914,6.582 -17.914,15.83 0,9.366 7.349,15.795 17.914,15.601 2.953,-0.11 7.027,-1.147 9.51,-2.742 z" inkscape:connector-curvature="0" /></svg>'
};
const PAY_METHODS = `<div class="footer-pay" role="list" aria-label="Способы оплаты">
        ...
        <span class="pay pay-mc" role="listitem">${PAY_MARKS.mastercard}${PAY_MARKS.mastercardWord}<span class="sr-only">Mastercard</span></span>
...
// apple.com, viewBox обрезан ровно по фигуре (bbox), поэтому в строке текста
// глиф стоит на базовой линии, как буква. Заливка currentColor: цвет и размер
// берутся у самого заголовка.
const APPLE_MARK = '<svg class="apple-mark" viewBox="0.51 12.25 12.98 15.94" aria-hidden="true">'
...
function homePage(settings, db, opts, site) {
    ...
    <section class="store-hero">
      <div class="container store-hero-inner">
        <div class="store-hero-copy">
          ...
          <h1>${APPLE_MARK}${esc(settings.tagline || 'Выбирайте нужную модель — мы поможем с остальным.')}</h1>
        </div>
      </div>
      ${BENEFIT_SPRITE}
  ...
  const body = `
    ...
    <section class="container section">
      <div class="section-head section-head-center"><h2>${heading}</h2></div>
