...
function storeCard(settings, map, opts) {
   ...
   * карты, и её убрали. */
  const acts = [
    phone ? `<a class="place-act place-act-main" href="tel:${esc(phoneHref(phone))}">${phoneIcon()}<span>Позвонить</span></a>` : '',
    tg ? `<a class="place-act place-act-round msg-tg" href="https://t.me/${esc(tg)}" target="_blank" rel="noopener" title="Telegram" aria-label="Написать в Telegram">${tgMark()}</a>` : '',
    waUrl ? `<a class="place-act place-act-round msg-wa" href="${esc(waUrl)}" target="_blank" rel="noopener" title="WhatsApp" aria-label="Написать в WhatsApp">${waMark()}</a>` : ''
  ].filter(Boolean).join('');
