...
function layout(settings, opts) {
  ...
  const navMessengers = [
    settings.contactTelegram
      ? `<a class="nav-item" href="https://t.me/${esc(tgUser(settings))}" target="_blank" rel="noopener">Telegram</a>` : '',
    waUrl
      ? `<a class="nav-item" href="${esc(waUrl)}" target="_blank" rel="noopener">WhatsApp</a>` : ''
  ].filter(Boolean).join('');
