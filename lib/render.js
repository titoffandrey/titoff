 ...
 * версия круга с самолётиком выдавала себя сразу. Взяты с Викисклада
 ...
 *    одинаковых 22 px;
 *  - **id градиентов с приставкой `msg-`**: в брендбуках они называются `a`,
 *    `b`, `linear-gradient`, и два таких логотипа на одной странице красились
 *    бы градиентом друг друга (та же грабля, что у логотипов перевозчиков).
 * Белые детали нарисованы поверх заливки, поэтому значок самодостаточен и не
 * зависит от фона кнопки. Фирменные цвета не притемняются: правило контраста
 * 4.5:1 в проекте про ТЕКСТ, а подпись рядом остаётся тёмной. */
function tgMark() {
  return "<svg class=\"msg-ico\" viewBox=\"0 0 240 240\" aria-hidden=\"true\"><defs><linearGradient id=\"msg-tg\" x1=\"120\" y1=\"240\" x2=\"120\" gradientUnits=\"userSpaceOnUse\"><stop offset=\"0\" stop-color=\"#1d93d2\"/><stop offset=\"1\" stop-color=\"#38b0e3\"/></linearGradient></defs><circle cx=\"120\" cy=\"120\" r=\"120\" fill=\"url(#msg-tg)\"/><path fill=\"#c8daea\" d=\"M81.229,128.772l14.237,39.406s1.78,3.687,3.686,3.687,30.255-29.492,30.255-29.492l31.525-60.89L81.737,118.6Z\"/><path fill=\"#a9c6d8\" d=\"M100.106,138.878l-2.733,29.046s-1.144,8.9,7.754,0,17.415-15.763,17.415-15.763\"/><path fill=\"#fff\" d=\"M81.486,130.178,52.2,120.636s-3.5-1.42-2.373-4.64c.232-.664.7-1.229,2.1-2.2,6.489-4.523,120.106-45.36,120.106-45.36s3.208-1.081,5.1-.362a2.766,2.766,0,0,1,1.885,2.055,9.357,9.357,0,0,1,.254,2.585c-.009.752-.1,1.449-.169,2.542-.692,11.165-21.4,94.493-21.4,94.493s-1.239,4.876-5.678,5.043A8.13,8.13,0,0,1,146.1,172.5c-8.711-7.493-38.819-27.727-45.472-32.177a1.27,1.27,0,0,1-.546-.9c-.093-.469.417-1.05.417-1.05s52.426-46.6,53.821-51.492c.108-.379-.3-.566-.848-.4-3.482,1.281-63.844,39.4-70.506,43.607A3.21,3.21,0,0,1,81.486,130.178Z\"/></svg>";
}
function waMark() {
  return "<svg class=\"msg-ico\" viewBox=\"26.01 25.23 122.31 122.32\" aria-hidden=\"true\"><defs><linearGradient id=\"msg-wa\" x1=\"85.915\" x2=\"86.535\" y1=\"32.567\" y2=\"137.092\" gradientUnits=\"userSpaceOnUse\"><stop offset=\"0\" stop-color=\"#57d163\"/><stop offset=\"1\" stop-color=\"#23b33a\"/></linearGradient></defs><path fill=\"url(#msg-wa)\" d=\"M87.184 25.227c-33.733 0-61.166 27.423-61.178 61.13a60.98 60.98 0 0 0 9.349 32.535l1.455 2.313-6.179 22.558 23.146-6.069 2.235 1.324c9.387 5.571 20.15 8.517 31.126 8.523h.023c33.707 0 61.14-27.426 61.153-61.135a60.75 60.75 0 0 0-17.895-43.251 60.75 60.75 0 0 0-43.235-17.928z\"/><path fill=\"#fff\" fill-rule=\"evenodd\" d=\"M68.772 55.603c-1.378-3.061-2.828-3.123-4.137-3.176l-3.524-.043c-1.226 0-3.218.46-4.902 2.3s-6.435 6.287-6.435 15.332 6.588 17.785 7.506 19.013 12.718 20.381 31.405 27.75c15.529 6.124 18.689 4.906 22.061 4.6s10.877-4.447 12.408-8.74 1.532-7.971 1.073-8.74-1.685-1.226-3.525-2.146-10.877-5.367-12.562-5.981-2.91-.919-4.137.921-4.746 5.979-5.819 7.206-2.144 1.381-3.984.462-7.76-2.861-14.784-9.124c-5.465-4.873-9.154-10.891-10.228-12.73s-.114-2.835.808-3.751c.825-.824 1.838-2.147 2.759-3.22s1.224-1.84 1.836-3.065.307-2.301-.153-3.22-4.032-10.011-5.666-13.647\"/></svg>";
}
...
function layout(settings, opts) {
  ...
  /* Поиск живёт в ДВУХ местах, и одновременно виден ровно один: на широком
   * экране строка стоит в шапке, на телефоне уезжает в меню. Прежняя лупа,
   * выдвигавшая второй ряд, снята вместе с ней — в меню поиск лежит там же, где
   * разделы, то есть на один вопрос («куда пойти») отвечает одно нажатие.
   * Спрятанная половина убирается `display:none`, а не прозрачностью: иначе
   * скринридер нашёл бы на странице два одинаковых поля поиска. */
  ...
  /* В подвале те же два адреса — парой одинаковых кнопок. Разметка у них одна
   * (`msg-link`), различаются только значок и ссылка: своя пара классов на
   * сервис означала бы, что Telegram и WhatsApp разъедутся по виду на первой
   * правке, а увидеть это можно только глазами. Обёртки-`div` вокруг каждой
   * кнопки нет — ряд собирает сам `msg-links`. */
  const footMessengers = [
    settings.contactTelegram
      ? `<a class="msg-link" href="https://t.me/${esc(tgUser(settings))}" target="_blank" rel="noopener">${tgMark()}<span>Telegram</span></a>` : '',
    waUrl
      ? `<a class="msg-link" href="${esc(waUrl)}" target="_blank" rel="noopener">${waMark()}<span>WhatsApp</span></a>` : ''
  ].filter(Boolean).join('');
...
<div class="nav-wrap">
  ...
  <nav class="nav-panel" aria-label="Разделы"><div class="nav-list">
    ${searchForm('nav-search', 'search-menu')}
    ${navItems}
    ${navContacts}
  </div></nav>
</div>
...
<footer class="site-footer">
  <div class="container footer-grid">
    <div class="footer-cols">
      ...
      ${/* «Покупателю» — все страницы, которые нужны уже после нажатия «купить».
           Отслеживание стоит первым: это единственный путь к своей посылке,
           если страница оплаты закрыта, а ссылку из переписки он не нашёл. */''}
      <nav class="footer-col" aria-label="Покупателю">
        <div class="footer-col-head">Покупателю</div>
        <ul class="footer-col-list">
          <li><a href="/track">Отследить заказ</a></li>
          ${/* «О компании» стоит между действием и условиями: сперва то, зачем
               в подвал приходят чаще всего, потом «кто вы такие», и только за
               ними — документы, которые читают по конкретному поводу. */''}
