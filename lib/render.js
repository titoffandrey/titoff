...
<footer class="site-footer">
  <div class="container footer-grid">
    ...
    <div class="footer-bottom">
      <div class="foot-legal">${esc(settings.footerNote || 'Оригинальная техника с гарантией')}</div>
      <div class="foot-legal"><a href="/admin">Для администратора</a></div>
    </div>
  </div>
</footer>
...
module.exports = { esc, money, formatDate, stars, layout, homePage, productPage, imageMarkup, placeholderSvg, assetV, brandFields, cssColor };
