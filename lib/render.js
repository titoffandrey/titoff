...
function privacyPage(settings, opts) {
  ...
  const body = `<div class="container legal-page">
    ...
    <header class="legal-hero">
      ...
      <p>Редакция от 27 июля 2026 года</p>
    </header>
    ...
    <div class="legal-card">
      ...
      <section class="legal-section" id="purposes">
        ...
        <div class="legal-table-wrap"><table class="legal-table purposes-table"><thead><tr><th>Цель</th><th>Данные</th><th>Основание</th></tr></thead><tbody>
          <tr><td>Обработка заявки и связь с покупателем</td><td>Имя, контакт, комментарий, заказ</td><td>Действия по инициативе посетителя до заключения договора и исполнение договора (п. 5 ч. 1 ст. 6 Закона № 152-ФЗ)</td></tr>
...
function personalDataConsentPage(settings, opts) {
  ...
  const body = `<div class="container legal-page">
    ...
    <header class="legal-hero"><span class="section-kicker">Отдельный документ</span><h1>Согласие на обработку персональных данных</h1><p>Редакция от 27 июля 2026 года</p></header>
    <div class="legal-card">
...
function publicationConsentPage(settings, opts) {
  ...
  const body = `<div class="container legal-page">
    ...
    <header class="legal-hero"><span class="section-kicker">Отдельный документ</span><h1>Согласие на обработку персональных данных, разрешённых для распространения</h1><p>Редакция от 27 июля 2026 года</p></header>
    <div class="legal-card">
      <section class="legal-section"><h2>Оператор</h2>${operatorCard(settings)}</section>
      <section class="legal-section">
