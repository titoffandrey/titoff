      ...
      <p class="pay-hint">${hosted
        ? (pay.provider === 'alfabank'
          ...
          : pay.method === 'SBP_ONLINE'
            ? 'Ссылка СБП откроется в новой вкладке: на телефоне — сразу в приложении банка, на компьютере — страница с QR-кодом и списком банков. Сумма там уже указана, подтвердите платёж в банке. Эту страницу не закрывайте: когда оплата подтвердится, она обновится сама.'
