...
function contactIcon(body) { return `<svg class="msg-ico" viewBox="0 0 24 24" aria-hidden="true">${body}</svg>`; }
function phoneIcon() { return contactIcon('<path fill-rule="evenodd" d="M8.6 1.6h6.8A2.6 2.6 0 0 1 18 4.2v15.6a2.6 2.6 0 0 1-2.6 2.6H8.6A2.6 2.6 0 0 1 6 19.8V4.2a2.6 2.6 0 0 1 2.6-2.6Zm1.15 2.6a.55.55 0 0 0 0 1.1h4.5a.55.55 0 0 0 0-1.1h-4.5Z"/>'); }
function mailIcon() { return contactIcon('<path d="M2.4 6.2A2 2 0 0 1 4.4 4.5h15.2a2 2 0 0 1 2 1.7L12 12.6 2.4 6.2Z"/><path d="M2.25 8.2 11.6 14.4a.7.7 0 0 0 .8 0l9.35-6.2V17a2 2 0 0 1-2 2H4.25a2 2 0 0 1-2-2V8.2Z"/>'); }
function clockIcon() { return contactIcon('<path fill-rule="evenodd" d="M12 2.4a9.6 9.6 0 1 0 0 19.2 9.6 9.6 0 0 0 0-19.2Zm-.85 4.6a.85.85 0 0 1 1.7 0v4.92l3.29 1.9a.85.85 0 1 1-.85 1.47l-3.71-2.14a.85.85 0 0 1-.43-.74V7Z"/>'); }
