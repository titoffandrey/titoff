 ...
 * (см. там же). Наборов три — у первого экрана товара (галерея, ряды выбора,
 * кнопка) правил вдвое больше, чем у главной, и одним общим набором главная
 * возила бы чужие. Ключ набора — вид страницы; страница без набора грузит
...
const CRITICAL_KINDS = ['home', 'catalog', 'product'];
const CRITICAL_CSS = {};
...
// Вид страницы для набора критических стилей: товар, главная, каталог.
function criticalKind(opts) {
  if (opts.productPage) return 'product';
  if (opts.tab === 'home') return 'home';
...
module.exports = {
  ...
  cardName, cardNameStorageOn, startStorageLabel,
