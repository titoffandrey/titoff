  ...
  <div class="container footer-grid">
    ...
    <div class="footer-bottom">
      ...
      <div class="footer-meta">
        ...
        <!-- Авторство OpenStreetMap: часть адресов пунктов выдачи берётся оттуда
             (lib/pickup-osm.js), а её лицензия требует указать источник. Стоит
             оно здесь, а не на оформлении: на последнем шаге перед оплатой
             каждая лишняя строка читается как работа, которую ещё надо сделать,
             а требование лицензии подвал закрывает ровно так же. -->
        <div class="foot-legal">Адреса пунктов выдачи — частично данные <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener">OpenStreetMap</a>.</div>
      </div>
      ...
      <div class="review-form-wrap">
        ...
        <form id="review-form" class="rf-grid" enctype="multipart/form-data">
          ...
          ${REVIEW_PHOTOS ? `<div class="field rf-photos">
            <label for="rv-photos">Фото <span class="rf-sub">до ${REVIEW_PHOTOS_MAX}, по желанию</span></label>
            <input type="file" id="rv-photos" name="photos" accept="image/*" multiple>
          </div>` : ''}
          <div class="field rf-text">
            <label for="rv-text">Отзыв</label>
            <textarea id="rv-text" name="text" rows="3" maxlength="2000" placeholder="Поделитесь впечатлением о товаре"></textarea>
          </div>
          <div class="rf-send">
            <button type="submit" class="btn btn-primary">Отправить отзыв</button>
            <p class="form-legal-note">Согласия подтвердите на следующем шаге. <a href="/privacy" target="_blank" rel="noopener">Политика</a></p>
          </div>
