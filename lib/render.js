...
function checkoutPage(settings, opts) {
  ...
  /* Личный кабинет. Вошедшему подставляются почта, имя и телефон; тому, кто не
   * вошёл, поле почты обещает кабинет — но только когда есть чем прислать
   * пароль (`auto`). Ключей почты здесь нет: витрина знает лишь «пришлём». */
    ...
    <div class="legal-card">
      ...
      <section class="legal-section" id="purposes">
        ...
        <div class="legal-table-wrap"><table class="legal-table purposes-table"><thead><tr><th>Цель</th><th>Данные</th><th>Основание</th></tr></thead><tbody>
          ...
          ${accountsOn ? `<tr><td>Личный кабинет покупателя</td><td>E-mail, хеш пароля, имя, телефон, заказы кабинета</td><td>Запрос посетителя на использование функций сайта; исполнение договора (п. 5 ч. 1 ст. 6 Закона № 152-ФЗ)</td></tr>` : ''}
