...
// Способы оплаты в подвале. Собраны разметкой, а не картинками: ни одного
// лишнего запроса и никакой растровой мазни при масштабировании. У Mastercard
// геометрия фирменная — два круга радиуса 8 на расстоянии 10 и линза их
// пересечения (её крайние точки x=13, y=8±6.245), у остальных знак набран
// шрифтом системы в фирменном цвете.
const MASTERCARD_MARK = '<svg viewBox="0 0 26 16" aria-hidden="true">'
  + '<circle cx="8" cy="8" r="8" fill="#eb001b"/><circle cx="18" cy="8" r="8" fill="#f79e1b"/>'
  + '<path d="M13 1.755A8 8 0 0 1 13 14.245A8 8 0 0 1 13 1.755z" fill="#ff5f00"/></svg>';
const PAY_METHODS = `<div class="footer-pay" role="list" aria-label="Способы оплаты">
        <span class="pay pay-mir" role="listitem">МИР</span>
        <span class="pay pay-visa" role="listitem">VISA</span>
        <span class="pay pay-mc" role="listitem">${MASTERCARD_MARK}<span class="sr-only">Mastercard</span></span>
