...
const BENEFIT_ICON = (d) => `<svg viewBox="0 0 35 35" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linejoin="round" aria-hidden="true">${d}</svg>`;
const HERO_BENEFITS = [
  // Ценник с отверстием
  ['Оптовые цены', BENEFIT_ICON('<path d="M5.99 3.94h11.51l11.65 11.64a2.72 2.72 0 0 1 0 3.84L19.42 29.15a2.72 2.72 0 0 1-3.84 0L3.94 17.5V5.99a2.05 2.05 0 0 1 2.05-2.05z"/><circle cx="9.87" cy="9.87" r="1.67"/>')],
  // Щит с галочкой — контур повторяет spec-icons/shield.svg
  ['1 год гарантии', BENEFIT_ICON('<path d="M17.5 5.85c3.1 2.06 6.57 3.14 9.57 3.33v8.22c0 6.45-4.12 10.92-9.57 12.9-5.45-1.98-9.57-6.45-9.57-12.9v-8.22c3-.19 6.47-1.27 9.57-3.33z"/><path d="M13.34 17.92l3.02 3.02 5.51-5.82" stroke-linecap="round"/>')],
  // Фургон доставки
  ['Быстрая доставка', BENEFIT_ICON('<rect x="3.9" y="8.9" width="15.3" height="13" rx="1.8"/><path d="M19.2 13.4h4.9c.42 0 .82.19 1.09.51l3.1 3.72c.21.25.32.56.32.88v3.39h-9.4z"/><circle cx="9.3" cy="24" r="2.4"/><circle cx="24.5" cy="24" r="2.4"/>')]
];
    ...
    <section class="store-hero">
      <div class="container store-hero-inner">
        ...
        <ul class="store-benefits" aria-label="Преимущества магазина">
          ${HERO_BENEFITS.map(([text, ico]) => `<li>${ico}<span>${text}</span></li>`).join('')}
        </ul>
      </div>
    </section>` : '';
