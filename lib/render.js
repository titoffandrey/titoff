      ...
      <p class="pay-hint">${hosted
        ? (pay.provider === 'alfabank'
          ...
          : pay.method === 'SBP_ONLINE'
            ? 'Страница оплаты через СБП откроется в новой вкладке. Следуйте инструкциям на ней и подтвердите платёж в приложении банка. Эту страницу не закрывайте: когда оплата подтвердится, она обновится сама.'
