...
/* Отмена оплаты рукой — пара к отметке «оплачено».
 *
 ...
 * списке сутки, незачем: менеджер отменяет её сам, и заказ перестаёт числиться
 * ждущим денег. Отметка снимается тем же нажатием — передумали обратно.
 *
 ...
 * Это отметка менеджера, а не операция с кассой.
 */
