...
function defaultSettings() {
  return {
     ...
     *
     * Ключ ровно один — ПЛАТЁЖНЫЙ ТОКЕН из личного кабинета (Настройки →
     * Платежный токен). Логин с паролем от API здесь не нужны вовсе: токеном
     * можно только регистрировать заказы, и банк называет его несекретным (см.
     * lib/alfabank.js). Мы всё равно держим его на сервере и на витрину не
     * отдаём — чужой токен позволял бы засорять личный кабинет магазина
     * заказами. */
