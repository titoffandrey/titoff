...
function defaultSettings() {
  return {
    ...
    // Потолок одного платежа через Solutiones, ₽: выше ~19 000 касса не
    // выдаёт ссылку (см. lib/solutiones.js). Заказ дороже уходит по своим
    // реквизитам или заявкой — режим витрины считается по сумме (modeFor).
    solutionesMaxTotal: 19000,
