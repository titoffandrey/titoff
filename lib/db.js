...
function defaultSettings() {
  return {
    ...
    // трансграничные у кассы включены, но владелец добавляет их сам, когда
...
function ordersForSite(siteId) { return visibleOrders().filter(o => o.siteId === siteId); }
...
module.exports = {
  ...
  getOrders, visibleOrders, getOrder, createOrder, promoteOrder, updateOrderClient, ordersForSite, setOrderStatus, deleteOrder,
