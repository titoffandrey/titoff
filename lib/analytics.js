...
class Analytics {
  ...
  snapshot(options) {
    ...
    for (const d of botRows) {
      ...
      for (const [k, n] of Object.entries(d.agents || {})) botTotals.agents[k] = (botTotals.agents[k] || 0) + n;
      for (const [k, n] of Object.entries(d.paths || {})) botTotals.paths[k] = (botTotals.paths[k] || 0) + n;
    }
