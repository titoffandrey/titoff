...
// Цена предварительного расчёта относится к зоне введённого адреса. Пункт
// выдачи должен относиться к ней же: иначе код далёкого ПВЗ можно отправить
// вместе с московским адресом и оплатить доставку по московскому тарифу.
// Это правило одинаково для списка предложений и окончательной заявки.
function sameZone(address, destination) {
  return Z.zoneFor(address) === Z.zoneFor(destination);
}
...
module.exports = { RATES, rate, quote, quoteAll, sameZone };
