...
const ICONS = {
  ...
  // Каталог — список с точками, тот же знак, что на вкладке нижней панели витрины.
  catalog: { glyph: '<path d="M4 6.3h.7M9.2 6.3h10.8M4 12h.7M9.2 12h10.8M4 17.7h.7M9.2 17.7h10.8" stroke-linecap="round"/>' },
  ...
  // Перечёркнутый круг — общепринятый знак запрета: им подписаны блокировки и
  // исключения в метрике.
  ban: { glyph: '<circle cx="12" cy="12" r="8.8"/><path d="m5.8 5.8 12.4 12.4" stroke-linecap="round"/>' },
